...
namespace MyHobbyList.Controllers
{
    ...
    public class GameController : EntityController
    {
        ...
        {
            var entities = GetEntities<Game>(false);
        ...
        public ActionResult Details(int id)
        {
            ...
            if (User.Identity.IsAuthenticated)
            {
                ...
                ViewBag.IsOwner = _context.Games.Any(x => x.CreateById.Equals(user.UserId) && x.Id == id);
                ViewBag.AlreadyAdded = user.Entities.Any(x => x.ElementType == ElementType.Game && x.Id == id);
            ...
            var entities = SameGenreEntities<Game>(id, element.Genre, entity != null ? entity.Id : 0);
