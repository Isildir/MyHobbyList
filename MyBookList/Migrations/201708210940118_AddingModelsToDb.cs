namespace MyBookList.Migrations
{
    ...
    public partial class AddingModelsToDb : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Description = c.String(maxLength: 255),
                        Studio = c.String(),
                        GameGenre_Id = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.GameGenres", t => t.GameGenre_Id, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Games", "GameGenre_Id", "dbo.GameGenres");
            DropForeignKey("dbo.Books", "BookGenre_Id", "dbo.BookGenres");
            ...
            DropIndex("dbo.Games", new[] { "GameGenre_Id" });
            DropIndex("dbo.Books", new[] { "BookGenre_Id" });
